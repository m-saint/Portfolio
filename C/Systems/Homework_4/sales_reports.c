...
/********************************************************
*   get_totals(int month_data[][13], int items, int months)
...
*       nothin
*********************************************************/
void get_totals(int month_data[][13], int items, int months){
...
/********************************************************
*   get_profits(int month_data[][13], int items, int months, float costs[], float purchases[])
...
*       items: the total number of items 
*       months: the number of months of data
*       purchases and costs: the price and cost of each item
*   Returns:
*       nothin
*********************************************************/
void get_profits(int month_data[][13], int items, int months, float costs[], float purchases[]){
    ...
    for (int i = 1; i < items; i++){
        ...
        float sales = numSold * purchases[i];
        float cost = numSold * costs[i];
        float revenue = sales - cost;

        fprintf(out, "%4d      %2d   %5.2f   %5.2f   %5.2f\n", i, numSold, sales, cost, revenue);
...
/********************************************************
*   top_earner(int month_data[][13], int items, int months, float costs[], float purchases[])
...
*       nothin
*********************************************************/
void top_earner(int month_data[][13], int items, int months,  float costs[], float purchases[]){
